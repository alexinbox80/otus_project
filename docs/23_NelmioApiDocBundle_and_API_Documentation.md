...
3. Исправляем класс `App\Controller\Web\GetFeed\v1\Manager`
    ...
    use App\Controller\Web\GetFeed\v1\Output\Response;use App\Controller\Web\GetFeed\v1\Output\TweetDTO;use App\Domain\Entity\User;use FeedBundle\Domain\Service\FeedService;
